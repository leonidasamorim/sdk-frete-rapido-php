...
use FreteRapido\Endpoints\ShippingCostV3;
 ...
 * @method ShippingCostV3 shippingCostV3()
...
class Client
{
    ...
    public function request(string $uri, string $method = "GET", array $options = [])
    {
        try {
            ...
            if (isset($body['transportadoras'][0]['oferta']) || isset($body['id_frete']))
    ...
    private function loadDefaults(): void
    {
        $this->endpoints = new Endpoints([
            ...
            "shippingCostV3" => ShippingCostV3::class,
